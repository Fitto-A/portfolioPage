...
export const data = [
        ...
        },
        {
            ...
            descriptionR: 'Juego de memoria hecho con React y CSS. Intentá clickear las 12 cartas sin repetir ninguna!',
        ...
        },
        {
            ...
            descriptionL: 'Web de compras hecha con React, React-router-dom y CSS.',
            moreInfoL: "The Odin Project's curriculum",
            urlL: 'https://fitto-a.github.io/shopping-cart/',
            repoL: 'https://github.com/Fitto-A/shopping-cart',
            id: 2,
        },
        {    
            ...
            descriptionR: 'Diseño de Logo y aplicaciones para redes sociales.',
        ...
        },
        {
            ...
            moreInfoL: "CochKart es un emprendimiento de servicios de, cochera y servis mecánico para kartings de competición. Con un nombre ya definido, se me solicitó la realización de un logo, tarjetas de contacto, adhesivos y unas placas para publicitar la marca en las redes sociales.",
