      ...
      <div className="proyectos-home-container" onClick={handleCloseBtn}>
        ...
        <span className="box-left">
          ...
          <div className="sp-desarrollo">
            <div
              className="selected-project-container-1"
              data-aos="fade-right"
            ...
            <div
              className="selected-project-container-2"
              data-aos="fade-right"
              data-aos-duration="1000"
            >
              <div className="proyect-info">
        ...
        <span className="box-right">
          ...
          <div className="sp-diseño">
            <div
              className="selected-project-container-3"
              data-aos="fade-right"
              data-aos-duration="1000"
            >
              <div className="sp-img-container">
                <img
                  className="sp-img-diseño"
                  src={proyecto2.srcL}
                  alt={proyecto2.nameL}
                />
              </div>
            ...
            <div
              className="selected-project-container-4"
              data-aos="fade-right"
              data-aos-duration="1000"
            >
              <div className="sp-img-container">
              ...
              <div className="proyect-info">
                ...
                <div className="links">
                  ...
                  {proyecto4.detailsR && (
                    <Link
                      className="animacion-btn-neg"
                      to={`/proyectos/${proyecto4.id}`}
                    >
                      <button
                        className="form-btn animacion-btn-neg"
                        data-aos="fade-right"
